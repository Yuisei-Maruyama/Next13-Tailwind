...
const Listbox: React.FC<Props> = ({dataList, selected, setSelected }) => {
      ...
      <BaseListBox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <BaseListBox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
